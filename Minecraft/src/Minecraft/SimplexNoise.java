...
* author: J. Woong, P. Leon; using code from Blackboard, the code was unchanged
* class: CS 445 – Computer Graphics
*
* assignment: Final Checkpoint
* date last modified: 6/1/2016
*
* purpose: To create a class using the simplex noise method from randomizing terrain
* 
****************************************************************/ 
package Minecraft;
